...
> [CAUTION]
> This package contains only the parser of the extension. It can not be used in a standalone fashion and should be only used as a dependency of the plugin `babel-plugin-left-side`.
